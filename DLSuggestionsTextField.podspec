#
#  Be sure to run `pod spec lint DLSuggestionsTextField.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => 'https://github.com/davidlivadaru/DLSuggestionsTextField.git', :tag => s.version }
